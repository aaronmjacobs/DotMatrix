...
uint8_t CPU::Operand::read8() const
{
   ...
   case Opr::DerefImm16:
      ...
      break;
   default:
      ASSERT(false, "Invalid 8-bit read operand: %hhu", opr);
      break;
   }
...
uint16_t CPU::Operand::read16() const
{
   ...
   case Opr::Imm16:
      ...
      break;
   default:
      ASSERT(false, "Invalid 16-bit read operand: %hhu", opr);
      break;
   }
...
void CPU::Operand::write8(uint8_t value)
{
   ...
   case Opr::DerefImm16:
      ...
      break;
   default:
      ASSERT(false, "Invalid 8-bit write operand: %hhu", opr);
      break;
   }
}
...
void CPU::Operand::write16(uint16_t value)
{
   ...
   case Opr::DerefImm16:
      ...
      break;
   default:
      ASSERT(false, "Invalid 16-bit write operand: %hhu", opr);
      break;
   }
}
