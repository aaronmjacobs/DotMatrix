...
{
public:
   static std::unique_ptr<Cartridge> fromData(std::vector<uint8_t> data, std::string& error);
...
private:
   ...
   void setController(std::unique_ptr<MemoryBankController> mbc)
   {
